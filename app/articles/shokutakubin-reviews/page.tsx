  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"BreadcrumbList\", \"itemListElement\": [{\"@type\": \"ListItem\", \"position\": 1, \"name\": \"\u30db\u30fc\u30e0\", \"item\": \"https://takushoku-biyori.com/\"}, {\"@type\": \"ListItem\", \"position\": 2, \"name\": \"\u53e3\u30b3\u30df\u30fb\u8a55\u5224\"}, {\"@type\": \"ListItem\", \"position\": 3, \"name\": \"\u98df\u5b85\u4fbf\u306e\u53e3\u30b3\u30df\u30fb\u8a55\u5224\"}]}" }}
      />
      ...
      <article className="max-w-3xl mx-auto px-4 py-8 md:py-12">
        ...
        <div className="bg-cream rounded-xl p-5 mb-8 text-sm leading-relaxed">
          ...
          <p className="mb-3">
            この記事では、<strong>食宅便の口コミ・評判を徹底リサーチ</strong>。公開情報・利用者の口コミをもとに、「病院食っぽくないか」「味は本当に美味しいか」を検証しました。
          </p>
          <p>
        ...
        <p className="text-sm mb-6 leading-relaxed">口コミや公開情報から見えてくる食宅便のメリットを5つにまとめました。</p>
